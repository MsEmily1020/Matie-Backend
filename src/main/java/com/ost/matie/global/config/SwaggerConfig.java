...
import com.ost.matie.global.annotation.SwaggerAPIError;
import com.ost.matie.global.annotation.SwaggerAPIErrors;
import com.ost.matie.global.exception.error.ErrorCode;
import com.ost.matie.global.exception.error.ErrorResponse;
import com.ost.matie.global.swagger.ExampleHolder;
...
public class SwaggerConfig {
    ...
    public OpenAPI api() {
        return new OpenAPI()
                .info(new Info().title("Matie API with Swagger")
                        .description("Matie Server의 swagger api 입니다.")
                        .version("1.0.0")
